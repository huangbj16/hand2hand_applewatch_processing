...
#initialize
left_sensor = Process('data/sound/log-20190305-IxB-WatchL.txt')
left_sensor.read_data()
left_sensor.preprocess_timing_gap()
# left.show_single_plot()
right_sensor = Process('data/sound/log-20190305-IxB-WatchR.txt')
...
left_audio = AudioProcess('data/sound/log-20190305-IxB-WatchL.wav')
left_audio.frequency_transform()
left_audio.mfcc_transform()
right_audio = AudioProcess('data/sound/log-20190305-IxB-WatchR.wav')
...
#align
left_sensor_start = 855
right_sensor_start = 864
left_audio_start = 343212
right_audio_start = 345446
...
AUDIO_TIME_THRESHOLD = 10#change
