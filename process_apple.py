...
#initialize
left = Process('data/motion/log-20190227-IxI-WatchL.txt')
left.read_data()
left.preprocess_timing_gap()
# left.show_single_plot()
right = Process('data/motion/log-20190227-IxI-WatchR.txt')
right.read_data()
...
np.save('training/motion/IxI_np', store_data_list)
